...
Official Inochi Creator compatibility is the separate #8 gate. CLI/MCP are later adapters over this same semantic core rather than independent implementations.
